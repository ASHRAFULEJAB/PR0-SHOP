...
const Footer = () => {
    return (
              ...
              <div className="bg-slate-700 px-4 lg:mt-96 lg:my-auto   pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-full md:px-24 lg:px-28 lg:py-24">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex">
                      ...
                      <a
                        ...
                        title="Our phone"
                        className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-neutral-800"
                      >
                        850-123-5021
                      </a>
                    </div>
